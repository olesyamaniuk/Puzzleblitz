document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".r-g-navigation-list");
  const headerRef = document.querySelector(".r-g-header");
  const navigationRef = document.querySelector(".r-g-navigation");
  ...
  document.querySelectorAll(".r-g-navigation-link").forEach((n) =>
...
function toggleAnswer(element) {
  ...
  const buttonImg = element.querySelector(".r-g-toggle-button img");
